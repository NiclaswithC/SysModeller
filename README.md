...
| **Vertrieb** | Layout | Module im **2D-Hallenlayout** anordnen (ziehen, Raster). Je Modul lässt sich eine **echte 3D-Datei (GLB/GLTF)** hinterlegen – Maße und Draufsicht-Silhouette werden automatisch abgeleitet, die **3D-Ansicht** (drehen/zoomen) zeigt CAD-Modelle, maßhaltige Hüllkörper und ETO-Platzhalter mit Notizen |
